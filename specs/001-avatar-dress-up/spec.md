...
3. **Given** o avatar está vestindo uma peça, **When** o jogador escolhe a opção de remover/nenhuma peça naquela categoria, **Then** o avatar deixa de exibir aquela peça.
...
Como jogador, eu quero personalizar as características do avatar antes de vesti-lo (como tom de pele, cabelo e corpo), para que o personagem se pareça com o que eu quero antes de escolher as roupas.
...
- **FR-002**: O sistema MUST permitir que o jogador personalize as características do avatar, incluindo no mínimo tom de pele e cabelo (estilo e cor).
- **FR-003**: O sistema MUST organizar as roupas em categorias, incluindo no mínimo: vestido, blusa, calça, short, sapato e acessório.
...
- **FR-006**: O sistema MUST permitir que o jogador remova uma peça de roupa de uma categoria, deixando aquela parte do avatar sem roupa.
...
- **Avatar**: Representa o personagem do jogador. Atributos principais: tom de pele, estilo de cabelo, cor de cabelo, e o conjunto de roupas atualmente vestidas (uma peça por slot do corpo).
